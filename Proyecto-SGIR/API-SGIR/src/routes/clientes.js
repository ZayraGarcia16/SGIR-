...
import { verifyJWT, verifyRol } from "../middleware/authMiddleware.js"  
 ...
 */
router.get('/clientes/regitro', verifyJWT, verifyRol(['Administrador', 'Usuario']), (req, res) => {
    // Asistencias relacionadas
